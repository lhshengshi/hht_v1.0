...
*/
#define CS_H GPIO_SetBits(GPIOB,GPIO_Pin_9)       //RS=1   
#define CS_L GPIO_ResetBits(GPIOB,GPIO_Pin_9)     //RS=0

#define SID_H GPIO_SetBits(GPIOB,GPIO_Pin_13)      //RW=1    
#define SID_L GPIO_ResetBits(GPIOB,GPIO_Pin_13);   //RW = 0

#define SCLK_H GPIO_SetBits(GPIOB,GPIO_Pin_14);    //EN = 1   
#define SCLK_L GPIO_ResetBits(GPIOB,GPIO_Pin_14);  //EN = 0
...
void Display_LCD_String(u8 x,u8 *p,u8 rtime);	 
void PutBMP(u8 *puts);
