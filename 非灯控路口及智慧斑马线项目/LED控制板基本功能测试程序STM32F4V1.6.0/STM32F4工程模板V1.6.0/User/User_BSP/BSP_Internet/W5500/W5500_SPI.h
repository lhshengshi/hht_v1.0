...
/* Private defines--------------------------------------*/
/*定义W5500的电源控制管脚*/
#define WIZ_Pwr			   GPIO_Pin_8
#define WIZ_Pwr_PORT	   GPIOA
#define WIZ_Pwr_RCC	       RCC_AHB1Periph_GPIOA
/*定义W5500的片选管脚*/
#define WIZ_SCS			   GPIO_Pin_12
#define WIZ_SCS_PORT	   GPIOB
#define WIZ_SCS_RCC	       RCC_AHB1Periph_GPIOB
/*定义W5500的RESET管脚*/
#define WIZ_RESET		   GPIO_Pin_8
#define WIZ_RESET_PORT	   GPIOD
#define WIZ_RESET_RCC	   RCC_AHB1Periph_GPIOD
/*定义W5500的INT管脚*/
#define WIZ_INT			   GPIO_Pin_15
#define WIZ_INT_PORT	   GPIOE
#define WIZ_INT_RCC	       RCC_AHB1Periph_GPIOE
///*定义SPI作为W5500的硬件接口*/
/* Private typedef -------------------------------------*/
/* Private macro ---------------------------------------*/
/* Private variables -----------------------------------*/
